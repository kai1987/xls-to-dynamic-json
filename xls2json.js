...
(function() {
  var CACHE, TYPE_INT, TYPE_ONE_TO_MANY, VALIDATION_KEY, VALIDATION_UNIQUE, convertJson, fs, make_dynamic_json, readOneToMany, xls,
  ...
  convertJson = function(fileName, sheetName) {
    var forginerKeyName, k, key, meta_data, newJson, nouse, obj, rawJson, sheet, v, validation, validationTemp, workbook, _i, _len, _ref, _ref1;
