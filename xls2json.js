...
(function() {
  var CACHE, TYPE_HASH_CODE, TYPE_INT, TYPE_ONE_TO_MANY, VALIDATION_KEY, VALIDATION_UNIQUE, bkdrhash, convertJson, fs, make_dynamic_json, readOneToMany, xls, xlsx,
  ...
  convertJson = function(fileName, sheetName) {
    var fileArr, forginerKeyName, k, key, meta_data, newJson, nouse, obj, rawJson, read, sheet, targetStr, v, validation, validationTemp, workbook, _i, _len, _ref, _ref1, _ref2;
